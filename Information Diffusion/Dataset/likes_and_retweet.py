...
class world_armies_data:
    def adgpi(self,api):
        ...
        if len(adgpi_results) > 0:
            with open('adgpi.csv','a',newline='') as f:
                    writer=csv.writer(f)
    ...
    def ISPR_Official(self,api):
        ...
        if len(ispr_results) > 0:
            with open('ispr.csv','a',newline='') as f:
                writer=csv.writer(f)
    ...
    def USArmy(self,api):
        ...
        if len(usarmy_results) > 0:
            with open('us.csv','a',newline='') as f:
                writer=csv.writer(f)
    ...
    def BritishArmy(self,api):
        ...
        if len(britisharmy_results) > 0:
            with open('british.csv','a',newline='') as f:
                writer=csv.writer(f)
    ...
    def AustralianArmy(self,api):
        ...
        if len(australianarmy_results) > 0:
            with open('australian.csv','a',newline='') as f:
                writer=csv.writer(f)
    ...
    def mod_russia(self,api):
        ...
        if len(russia_results) > 0:
            with open('russia.csv','a',newline='') as f:
                writer=csv.writer(f)
    ...
    def armeedeterre(self,api):
        ...
        if len(france_results) > 0:
            with open('france.csv','a',newline='') as f:
                writer=csv.writer(f)
